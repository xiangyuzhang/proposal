...
set size 1,0.7
plot  "DUM.txt" using ($1*2):16 title "[4]" with linespoints  lw 2.3 lc 3,  "OBF.txt" using ($1*2):16 title "[3]" with linespoints  lw 2.3 lc 2,  "c1908-time.log" using ($1*2):4 title "[2]" with linespoints  lw 2.3 lc 0
